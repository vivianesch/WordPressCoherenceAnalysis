...
MembersTotal<- rbind(totalOwner,totalAO,totalMO,totalLO, totalReporter,totalAR,totalMR,totalLR)
CoreGroup <- rbind("Owners","Active Owners","Median Owners","Alien Owners", "Reporters","Active Reporters","Median Reporters","Alien Reporters")
