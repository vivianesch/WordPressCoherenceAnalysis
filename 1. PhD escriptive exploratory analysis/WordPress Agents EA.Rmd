...
Component
#Graphics
barplot(Component$Freq, xlab = Component$Freq, ylab = Component$Var1, main="Frequency of Tickets Component",  col = rainbow(20))
...
Focuses
#Graphics
barplot(Focuses$Freq, xlab = Focuses$Freq, ylab = Focuses$Var1, main="Frequency of Tickets Focuses",  col = rainbow(20))
...
Keywords
#Graphics
barplot(Keywords$Freq, xlab = Keywords$Freq, ylab = Keywords$Var1, main="Frequency of Tickets Keywords",  col = rainbow(20))
...
#2.2.1 Filter the most active group of reporters (Which reporter with more than 10 tickets)
...
#2.2.2 Filter the median active group of reporters (Which reporter with less than 10 tickets and more than 4 tickets)
