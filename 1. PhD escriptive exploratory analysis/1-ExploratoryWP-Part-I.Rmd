...
Despite the most of ticket have no owner, there are not so many urgent issues. Aroud 93% of tickets are classified as Severity "normal", and 97% are classified as Priority "Normal". According with this description, are recommended analyse in a bivariable analysis the folow variables and levels:
